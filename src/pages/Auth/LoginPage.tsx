        ...
        <>
            <div className="md:flex " id="main-connexion">
                ...
                <div className="md:basis-8/12">
                    <form>
                        <label htmlFor="text" className=" ms-2 text-left text-sm font-medium dark:text-white"> Connectez-vous </label><br /><br />

                        <div className="mb-5">
                            <label htmlFor="email" className="block mb-2 text-left text-sm font-medium dark:text-white">Email</label>
                        ...
                        <div className="mb-5">
                            <label htmlFor="password" className="block mb-2 text-sm text-left font-medium dark:text-white">Mot de passe</label>
