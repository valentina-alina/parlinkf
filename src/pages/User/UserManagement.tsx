...
//           {users.map((event) => (
//             <Accordion.Panel className='w-full'>
//               <Accordion.Title className='hover:bg-violet-100'>     <div className="flex items-center space-x-4 rtl:space-x-reverse">
...
//                 <Link to={`/delete-user/${event.id}`} className="link text-red-800 text-bodyTest">
//                   <AiTwotoneDelete />
//                 </Link>
...
//               <Accordion.Content>
//                 <div className="min-w-0 flex-1">
//                   <p className="truncate text-sm text-gray-500 dark:text-gray-400">{event.email}</p>

//                 </div>
//                 <div className="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">{event.phone}</div>
